...
for db in verdicts.db memory.db market.db calendar.db users.db; do
...
for f in audit.jsonl watchdog.jsonl admin.jsonl agent_state.json proposals.json config.json; do
